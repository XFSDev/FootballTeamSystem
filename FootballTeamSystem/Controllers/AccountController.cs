        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    ////TempCode
                    //var roleStore = new RoleStore<IdentityRole>(new MsSqlDbContext());
                    //var roleManager = new RoleManager<IdentityRole>(roleStore);
                    //await roleManager.CreateAsync(new IdentityRole("CanManagePlayers"));
                    //await UserManager.AddToRoleAsync(user.Id, "CanManagePlayers");
